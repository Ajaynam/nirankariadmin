            ...
            <div className="bg-white  p-3 border-t-4 border-green-400">
              <div className="image overflow-hidden">
                <img
                  ...
                  src={`http://snmsangli.com/api/uploads/${encodeURIComponent(user.incharge_photo)}`}
                  alt=""
                />
              </div>
              <h1 className="text-gray-900 font-bold text-xl text-center leading-8 my-1">{user.incharge_name}</h1>
            
              <ul className="bg-gray-100 text-gray-800  py-2 px-3 mt-3  rounded shadow-sm">
                
                <li className=" text-center py-1">
                  <p>Member since</p>
                  <span className="ml-6">{user.incharge_doj}</span>
                </li>
              </ul>
            </div>
          </div>
              ...
              <div className="text-gray-700">
                <div className="grid md:grid-cols-2 text-sm">
                  ...
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">{user.incharge_gender}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Date of Birth</div>
                    <div className="px-4 py-2">{user.incharge_dob}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Marritial Status</div>
                    <div className="px-4 py-2">{user.incharge_marritialStatus}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Personal No.</div>
                    <div className="px-4 py-2">{user.incharge_personalNo}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Contact No.</div>
                    <div className="px-4 py-2">{user.incharge_mob}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Current Address</div>
                    <div className="px-4 py-2">{user.incharge_address}</div>
                  </div>
                 
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Email</div>
                    <div className="px-4 py-2">
                      <a className="text-blue-800" href={`mailto:${user.incharge_email}`}>
                       {user.incharge_email}
                      </a>
                    </div>
                  </div>
                  <div className="grid grid-cols-2">
                    ...
                    <div className="px-4 py-2">{user.incharge_booldG}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Education</div>
                    <div className="px-4 py-2">{user.incharge_education}</div>
                  </div>
                  <div className="grid grid-cols-2">
                    <div className="px-4 py-2 font-semibold">Occupation</div>
                    <div className="px-4 py-2">{user.incharge_occupation}</div>
                  </div>
