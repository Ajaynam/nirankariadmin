...
const SevadalGentsTable = () => {
    const dispatch = useDispatch();
    const navigate = useNavigate()

    const authState = useSelector((state) => state.auth);
    const branchId = authState.branchId; // Adjust this line based on your actual auth state structure
    // const branchId = authState.user.sanchalak_branchId; // Adjust this line based on your actual auth state structure
    ...
    const data = useSelector((state) => state.adminSevadalList.data.sevadalList);
    console.log(data)
    const loading = useSelector((state) => state.adminSevadalList.data.loading);
    const { pageIndex, pageSize, query, total, status } = useSelector((state) => state.adminSevadalList.data.tableData);
    ...
    //     dispatch(getSevadal({ data: { pageIndex, pageSize, query, status }, branchId }));
    // }, [dispatch, pageIndex, pageSize, query, status, branchId]);
...
export default SevadalGentsTable;
